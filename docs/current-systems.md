...
- `BootScene` generates procedural textures and decides whether to boot a test
  scenario or the normal menu flow.
- `MainMenuScene` routes first-time players into the orientation run state and
  returning players into the standard briefing flow.
...
| [src/game/data/OrientationData.ts](../src/game/data/OrientationData.ts)                   | Shift 0 onboarding step definitions, tutorial thresholds, and onboarding messaging.                                 |
...
| [src/game/profile/profileStorage.ts](../src/game/profile/profileStorage.ts)               | Persisted player profile flags for onboarding completion, audio, and motion preferences.                            |
...
| Main menu and onboarding | Routes new players through the orientation lesson and sends returning players into the normal briefing flow.                                                                                | [src/game/scenes/MainMenuScene.ts](../src/game/scenes/MainMenuScene.ts), [src/game/data/OrientationData.ts](../src/game/data/OrientationData.ts), [src/game/profile/profileStorage.ts](../src/game/profile/profileStorage.ts)                                                                                                                                                                                                                                    |
...
| Test scenarios           | Seeds specialized runs for onboarding, guard, search-guard, compute, search, utility, maintenance, content-exhausted, and tier1-4 verification.                                             | [src/game/data/TestScenarioData.ts](../src/game/data/TestScenarioData.ts)                                                                                                                                                                                                                                                                                                                                                                                        |
...
- The onboarding flow, briefing screen, and end-shift screen are live.
