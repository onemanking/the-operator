...
const TERMINAL_TEXT_STYLE: Phaser.Types.GameObjects.Text.TextStyle = {
...
export class TerminalPromptController {
  private readonly promptStartX = 260;
  private readonly promptMaxX = 760;
  private readonly lineHeight = 24;
  private readonly wordSpacing = 8;
